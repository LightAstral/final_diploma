"""
Django settings for solar_powered_hosting project.
...
SECRET_KEY = 'django-insecure-4^k4lv300*e-#y6@^2%x7ex(3jcgz0pfk_71ebwtzqn0_kngdi'
...
MIDDLEWARE = [
    ...
    'solar_hosting.middleware.DomainPurchaseMiddleware',
]

ROOT_URLCONF = 'solar_powered_hosting.urls'
...
WSGI_APPLICATION = 'solar_powered_hosting.wsgi.application'
